    ...
    */
    ...
    'katalog_kendaraan' => [
        'Toyota' => [
            ...
            'HiAce Commuter' => ['kursi' => 15, 'cc' => 2500],
            'HiAce Premio' => ['kursi' => 14, 'cc' => 2800],
            'Hilux' => 5,
        ...
        'Daihatsu' => [
            ...
            'Gran Max Minibus' => ['kursi' => 8, 'cc' => 1500],
        ...
        'Mitsubishi' => [
            'Colt Diesel' => 3,
            'Fuso Canter' => 3,
            'L300 Minibus' => ['kursi' => 9, 'cc' => 2500],
            'L300 Pick Up' => ['kursi' => 3, 'cc' => 2500],
            'Mirage' => ['kursi' => 5, 'cc' => 1200],
            'Outlander PHEV' => 5,
        ...
        'Isuzu' => [
            'Elf Microbus' => ['kursi' => 16, 'cc' => 2800],
            'Elf NLR' => ['kursi' => 3, 'cc' => 2800],
            'Elf NMR' => ['kursi' => 3, 'cc' => 2800],
            'MU-X' => ['kursi' => 7, 'cc' => 3000],
            'Panther' => ['kursi' => 7, 'cc' => 2500],
            'Traga' => ['kursi' => 3, 'cc' => 2500],
        ],
        'Kia' => [
            'Carens' => ['kursi' => 7, 'cc' => 1500],
            'Carnival' => ['kursi' => 11, 'cc' => 2200],
            'Grand Sedona' => ['kursi' => 11, 'cc' => 2200],
        ...
        'Mazda' => [
            'Biante' => ['kursi' => 8, 'cc' => 2000],
            'CX-3' => 5,
            'CX-30' => 5,
            'CX-5' => ['kursi' => 5, 'cc' => 2500],
            'CX-60' => 5,
        ...
        'Volkswagen' => [
            'Caravelle' => ['kursi' => 8, 'cc' => 2000],
            'Polo' => 5,
            'Tiguan' => 5,
            'Transporter' => ['kursi' => 8, 'cc' => 2000],
        ],
        'Mercedes-Benz' => [
            'Bus OH 1526' => ['kursi' => 59, 'cc' => 6400],
            'Bus OH 1626' => ['kursi' => 59, 'cc' => 7700],
            'E-Class' => 5,
            'S-Class' => 5,
            'Sprinter' => ['kursi' => 15, 'cc' => 2100],
            'Vito' => ['kursi' => 8, 'cc' => 2100],
        ],
        'BMW' => [
            'Seri 3' => 5,
            'Seri 5' => 5,
        ...
        'Hino' => [
            'Bus RK' => ['kursi' => 59, 'cc' => 7700],
            'Bus RN' => ['kursi' => 59, 'cc' => 7700],
            'Dutro' => ['kursi' => 3, 'cc' => 4000],
            'Ranger' => 3,
        ],
        'Golden Dragon' => [
            'Bus Pariwisata' => ['kursi' => 45, 'cc' => 6700],
            'Minibus' => ['kursi' => 19, 'cc' => 3800],
        ],
        'Zhongtong' => [
            'Bus Pariwisata' => ['kursi' => 45, 'cc' => 6700],
        ],
        'Scania' => [
            'Bus K360' => ['kursi' => 59, 'cc' => 9300],
            'Bus K410' => ['kursi' => 59, 'cc' => 12700],
        ],
        'Ford' => [
            'Everest' => ['kursi' => 7, 'cc' => 2000],
            'Ranger' => ['kursi' => 5, 'cc' => 2000],
        ],
        'Chevrolet' => [
