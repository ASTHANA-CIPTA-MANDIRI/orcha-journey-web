...
new #[Layout('components.layouts.admin')] #[Title('Admin | Create Bundling')]  class extends Component {
    ...
    public function save()
    {
        ...
        try {
            ...
            $this->success('berhasil menambah data bundling harga', redirectTo: '/admin/paket-wisata');
        } catch (Exception $e) {
    ...
    <div class="grid gap-5 lg:grid-cols-2">
        <div>
            <x-mary-form wire:submit="save" no-separator>
                <x-mary-input label="Nama" wire:model="name" placeholder="Contoh: Open Trip Pantai Gunungkidul" />
