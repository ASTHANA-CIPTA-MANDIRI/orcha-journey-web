    ...
    public function run(): void
    {
        foreach ($this->daftar() as $destinasi) {
            ...
            DestinationPopuler::create([
                ...$destinasi,
                // Wilayah diturunkan dari provinsinya, bukan ditulis ulang di
                // tiap baris: dua tempat yang menyatakan hal sama pasti
                // berselisih saat pembagian wilayahnya berubah — dan itu baru
                // saja terjadi ketika "Bali & Nusa Tenggara" dipecah dua.
                'wilayah' => config('orcha.provinsi_wilayah')[$destinasi['provinsi']] ?? 'jawa',
